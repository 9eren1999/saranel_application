        ...
        child: Column(
          children: [
            infoCard(
              ...
              'SEDEP Sosyal ve Ekonomik Destek Programı',
              'İstanbul Büyükşehir Belediyesi',
              "İstanbul Büyükşehir Belediyesi Sosyal ve Ekonomik Destek Programı (SEDEP), İstanbul'da yaşayan ve muhtaç durumda olan vatandaşlara maddi ve sosyal destek sağlayan bir programdır. Program kapsamında ihtiyaç sahibi ailelere nakit yardımı, gıda yardımı, yakacak yardımı, eğitim yardımı, sağlık yardımı, konut yardımı ve iş bulma yardımı gibi çeşitli destekler sunulmaktadır.SEDEP'e başvurabilmek için İstanbul'da ikamet ediyor olmak, muhtaç durumda olmak ve gerekli belgelerle başvuru yapmak gerekmektedir. Başvurular, ALO 153 çağrı merkezi, İstanbul Senin mobil uygulaması veya SEDEP internet sitesi üzerinden yapılabilmektedir.",
              () => toggleDetail(0),
              launchUrl1,
            ),
            infoCard(
              ...
              'Ankara Büyükşehir Belediyesi Sosyal Yardımlar Pogramı',
              'Ankara Büyükşehir Belediyesi',
              "Ankara Büyükşehir Belediyesi tarafından ihtiyaç sahibi vatandaşlara sunulan sosyal yardımlar, nakit yardımı, gıda yardımı, yakacak yardımı, eğitim yardımı, sağlık yardımı, konut yardımı ve iş bulma yardımı gibi çeşitli alanlarda gerçekleşmektedir.",
              () => toggleDetail(1),
              launchUrl2,
            ),
            infoCard(
