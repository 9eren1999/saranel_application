...
import '../genelayarlar/custompagerout.dart';
    ...
    return Scaffold(
      ...
      body: ListView(children: [
        ...
        Padding(
          ...
          child: Text(
              "Aşağıdaki kategorilerden dilediğin onaylı kuruluş ve kampanyalara güvenle bağış yapabilirsin.",
              textAlign: TextAlign.center,
              style: GoogleFonts.poppins(
                  fontSize: 12,
        ...
        Padding(
          padding:
              const EdgeInsets.only(right: 10, left: 10, top: 3, bottom: 4),
          child: Text(
              "Aşağıdaki kategorilerden sana uygun olan sosyal destek kampanyasına başvurunu yapabilirsin.",
              textAlign: TextAlign.center,
              style: GoogleFonts.poppins(
                  fontSize: 12,
                  fontWeight: FontWeight.w400,
                  ...
                  child: InkWell(
                    ...
                    child: Container(
                      ...
                      child: Column(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          Icon(Icons.add_circle, size: 35, color: Colors.white),
                          SizedBox(height: 10),
                          Text(
                            'Yeni İlan Ekle',
                            overflow: TextOverflow.ellipsis,
