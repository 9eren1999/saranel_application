          ...
          child: InkWell(
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  Icon(Icons.volunteer_activism_rounded, size: 35, color: Colors.white),
                  SizedBox(height: 10),
                  Text(
                    'Vakıflar',
          ...
          child: InkWell(
            ...
            child: Container(
              ...
              child: Column(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  Icon(Icons.health_and_safety_sharp, size: 35, color: Colors.white),
                  SizedBox(height: 10),
                  Text(
                    'Sivil Toplum \nKuruluşları',
                    overflow: TextOverflow.ellipsis,
          ...
          child: InkWell(
            ...
            child: Container(
              ...
              child: Column(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  Icon(Icons.stream_rounded, size: 35, color: Colors.white),
                  SizedBox(height: 10),
                  Text(
                    'SMA',
                    overflow: TextOverflow.ellipsis,
